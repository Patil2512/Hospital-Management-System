        ...
        Add_Patient()
            {
                ...
                ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/Icon/Add_Patient.jpg"));
                        ...
                        try 
                            {
                                ...
                                String q = "insert into patient(pat_id,name,username,password,email,father_name,phone,marital_status,city,gender,blood,address,disease,dob,age) values('"+pat_id +"','"+name+"','"+username+"','"+password+"','"+email+"','"+fname+"','"+phone+"','"+marital_status+"','"+city+"','"+gender+"','"+blood+"','"+address+"','"+disease+"','"+dob+"','"+age+"')";
                                obj.stm.executeUpdate(q);
                                JOptionPane.showMessageDialog(null,"Patient Details Succesfully Inserted ");
                                //f.setVisible(false);
                            }
                        catch(Exception ex)
                            {
