                                            ...
                                            while(rest.next())
                                                {
                                                    ...
                                                    t12.setText(rest.getString("disease"));
                                                    l1.add(t12);
                ...
                if(e.getSource()==bt1)
                    {
                        ...
                        try 
                            {
                                ConnectionClass obj = new ConnectionClass(); 
                                String q2 = "update patient set name='"+name+"',email='"+email+"',father_name='"+fname+"',phone='"+phone+"',marital_status='"+marital_status+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',address='"+address+"',disease='"+disease+"',dob='"+dob+"',age='"+age+"'where username='"+username+"'";
