                    ...
                    Add_Appointment()
                        {
                            ...
                            ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/Icon/AddAppointment_Img.jpg"));
                            Image img1=img.getImage().getScaledInstance(300,700,Image.SCALE_SMOOTH);
