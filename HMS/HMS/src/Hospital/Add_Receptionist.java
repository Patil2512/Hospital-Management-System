        ...
        Add_Receptionist()
            {
                ...
                ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/Icon/Add_Receptionist.jpg"));
                        ...
                        try 
                            {
                                ...
                                String q = "insert into Receptionist values('"+res_id+"','"+name+"','"+username+"','"+password+"','"+email+"','"+fname+"','"+phone+"','"+qualification+"','"+city+"','"+gender+"','"+blood+"','"+address+"','"+joining_date+"','"+dob+"','"+age+"')";
                                obj.stm.executeUpdate(q);
                                JOptionPane.showMessageDialog(null,"Receptionist Details Succesfully Inserted");
                                f.setVisible(false);
                            }
                        catch(Exception ex)
                            {
