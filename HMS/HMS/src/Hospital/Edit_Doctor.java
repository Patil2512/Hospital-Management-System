                        ...
                        if(rest0.next())
                            {
                                ...
                                ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/Icon/Add_Doctor.jpg"));
                ...
                if(e.getSource()==bt1)
                    {
                        ...
                        String job=t13.getText();
                        String splz=t14.getText();
                        
                        try 
                            {
                                ConnectionClass obj = new ConnectionClass(); 
                                String q2 = "update doctor set name='"+name+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',age='"+age+"',clinic_no='"+clinic+"',joining_date='"+job+"',spcialization='"+splz+"'where username='"+username+"'";
