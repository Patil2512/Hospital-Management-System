        ...
        Index()
            {
                ...
                ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hospital/Icon/Index_Img.jpg"));
                Image i1=img.getImage().getScaledInstance(800, 570,Image.SCALE_SMOOTH );
                ImageIcon img1=new ImageIcon(i1);
                l1.setIcon(img1);
        
                l2=new JLabel("A C P Hospital Group");
                l2.setBounds(70,315,500,30);
                l2.setFont( new Font ("Copperplate Gothic Light",Font.BOLD,30));
                ...
                l3.setFont( new Font ("Copperplate Gothic Light",Font.BOLD,13));
