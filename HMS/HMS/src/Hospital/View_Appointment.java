...
public class View_Appointment extends JFrame implements ActionListener
    {
        String x[]={"Appointment Id","Username","Name","Email","Father Name","Phone","Marital Status","city","Gender","Blood Group","Age","DOB","Disease","Doctor","Appointment Date","Appointment Time","Appointment Status"};
        JButton bt,bt1;  
